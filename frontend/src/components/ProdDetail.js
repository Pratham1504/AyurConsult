...
const ProdDetail = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                ...
                // Ensure ratings is initialized as an array
    ...
    const submitReview = async () => {
        ...
        try {
            ...
            // Update product state to include the new review
    ...
    // Show loading message if the product is still being fetched
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="text-green-500 ml-4">{Math.round((product.MRP - product.price) / product.MRP * 100)}% off</span>
                    </div>
