...
const CreateEbook = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        formDataObj.append('file', file); // Ensure this field name matches the backend
        ...
        try {
            ...
            setTimeout(() => {
                navigate('/admin/ebooks'); // Redirect after 2 seconds
            }, 2000);
        } catch (err) {
        ...
        <div className="p-6 bg-white py-8 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6">
            ...
            <style jsx>{`
                .loader {
                    ...
                    margin-left: 10px; // Spacing next to button text
                }
